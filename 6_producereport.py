...
#         print("Calculated Total:", "${:.2f}".format(calculated_total))
#         print("Stated Total:", "${:.2f}".format(stated_total))
#         print()
#         # f"{produce}:, Stated Total - {stated_total}, Calculated Total - {calculated_total}"
#         # )
